...
import { ComponentsDictionary, Document, Schema } from './useDocument';
import { ComponentConfiguration } from '../../../shared/contracts/components';
import { Metadatas, FindContentTypeConfiguration, Settings } from '../../../shared/contracts/content-types';
import { Filters, InputProps, Table } from '@strapi/strapi/admin';
