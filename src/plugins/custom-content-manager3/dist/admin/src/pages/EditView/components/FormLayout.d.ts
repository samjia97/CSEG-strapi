...
export declare const ResponsiveGridItem: import('styled-components/dist/types').IStyledComponentBase<"web", import('styled-components/dist/types').Substitute<Omit<import('@strapi/design-system').TransientBoxProps & {
    children?: React.ReactNode;
} & import('@strapi/design-system/dist/types').AsProp<React.ElementType<any, keyof React.JSX.IntrinsicElements>> & Omit<Omit<any, "ref">, "children" | keyof import('@strapi/design-system/dist/types').AsProp<C> | keyof import('@strapi/design-system').TransientBoxProps> & {
    ref?: any;
    ...
    col: number;
}>> & string & Omit<Grid.ItemComponent<"div">, keyof React.Component<any, {}, any>>;
