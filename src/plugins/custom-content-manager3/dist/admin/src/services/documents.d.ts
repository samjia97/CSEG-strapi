import { Clone, Create, Delete, Find, FindOne, BulkDelete, BulkPublish, BulkUnpublish, Discard, CountDraftRelations, Publish, Unpublish, Update } from '../../../shared/contracts/collection-types';
...
}, import('@reduxjs/toolkit/query').BaseQueryFn<string | import('@strapi/admin/strapi-admin').QueryArguments, unknown, import('@strapi/admin/strapi-admin').BaseQueryError, {}, {}>, "GuidedTourMeta" | "HomepageKeyStatistics" | "AIUsage" | "AIFeatureConfig" | "ComponentConfiguration" | "ContentTypesConfiguration" | "ContentTypeSettings" | "Document" | "InitialData" | "HistoryVersion" | "Relations" | "UidAvailability" | "RecentDocumentList" | "CountDocuments" | "UpcomingReleasesList" | "AILocalizationJobs", Find.Response, "adminApi">>, useLazyGetDocumentQuery: import('@reduxjs/toolkit/dist/query/react/buildHooks').UseLazyQuery<import('@reduxjs/toolkit/query').QueryDefinition<Pick<FindOne.Params, "model"> & Partial<Pick<FindOne.Params, "documentId">> & {
    collectionType: string;
    params?: {
        locale?: string | null | undefined;
    } | undefined;
